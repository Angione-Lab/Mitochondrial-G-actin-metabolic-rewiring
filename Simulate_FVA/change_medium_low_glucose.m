function [model,basisMediumRPMI]  = change_medium_low_glucose(model, closed)
%changeMedia_batch
...
[model,basisMediumRPMI] = setMediumConstraints(model, set_inf, current_inf, medium_composition, met_Conc_mM, cellConc, t, cellWeight, mediumCompounds, mediumCompounds_lb);
